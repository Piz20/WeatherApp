...
class _SearchPageState extends State<SearchPage> {
  ...
  final String _weatherAPIApiKey =
      '6a5fdf1096094ee3812233148240310'; // Remplacez par votre clé API Tomorrow
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color:
                      isDarkTheme ? const Color(0xFF424242) : Colors.grey[200],
            ...
            child: _isLoading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      var coordinates =
                          _suggestions[index]['geometry']['coordinates'];
